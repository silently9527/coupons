		...
		<view class="cu-item shadow">
			<view class="image">
				...
				<view class="favor-btn" @tap.stop="doAppreciate(item)">
					<text class="icon icon-appreciatefill text-xxl"
						:class="item.appreciate?'text-red':'text-gray'"></text>
				</view>
			</view>
			<view class="solid-top flex justify-between align-center padding-top padding-left padding-right">
				<view>
					...
					<text class="padding-left icon icon-appreciatefill text-gray text-sm">
						{{item.appreciateCount}} 赞</text>
				</view>
				<view class="text-sm">
			...
			<view class="cu-list padding-sm">
				<view class="cu-item">
					<view v-for="tag in item.tags" :key="tag.tagId" class='cu-tag line-gray radius padding-sm'>
						{{tag.name}}
					</view>
				</view>
