...
<style scoped>
	...
	.refresh-moudle .pull-refresh .down-tip,
	.refresh-moudle .pull-refresh .up-tip,
	.refresh-moudle .pull-refresh .refresh-tip {
	  display: flex;
	  align-items: center;
	...
	.refresh-moudle .pull-refresh .down-img,
	.refresh-moudle .pull-refresh .up-img,
	.refresh-moudle .pull-refresh .refresh-img {
	  width: 50upx;
	  height: 50upx;
	  margin-right: 30upx;
	}
