		...
		<view class="cu-list menu padding-top-sm">
			...
			<view v-else class="cu-item user">
				...
				<view class="content flex align-center" @tap="toLogin">
					<view class="cu-avatar round xl inline"
						style="background-image:url(http://file.szjx.top/fashion/missing-face.png)"></view>
					<text class="text-black margin-left text-xl">登录/注册></text>
				</view>
				<!-- #endif -->
				<!--#ifdef MP-WEIXIN || MP-QQ-->
				<view class="content flex align-center">
					<view class="cu-avatar round xl inline margin-right"
						style="background-image:url(http://file.szjx.top/fashion/missing-face.png)"></view>
					<button class="username login-btn" open-type="getUserInfo"
						@getuserinfo="minProgramLogin">登录/注册></button>
				</view>
				<!-- #endif -->
			</view>
		</view>
