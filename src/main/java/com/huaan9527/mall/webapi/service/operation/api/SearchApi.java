...
@Slf4j
@Component
public class SearchApi extends AbstractDaTaoKeApi {
    private static final String url = "https://openapi.dataoke.com/api/goods/get-dtk-search-goods";

    public SearchApi(DaTaoKeProperties daTaoKeProperties) {
