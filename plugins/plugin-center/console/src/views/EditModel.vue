  ...
  >
    <a-spin :spinning="loading">
      ...
      >
        ...
        <a-form-model-item label="插件Code" prop="pluginCode">
          <a-input v-model="form.pluginCode" />
        </a-form-model-item>
        ...
        <a-form-model-item label="文件路径" prop="downloadUrl">
        ...
        <a-form-model-item label="引导提示" prop="remark">
    ...
    data () {
      return {
        ...
        rules: {
          ...
          pluginCode: [
            { required: true, message: '插件Code不能为空', trigger: 'blur' }
          ],
          author: [
